        ...
        @foreach($notificaciones as $notificacion)
            <div class="notification mb-3 p-3 border rounded">
                @if($notificacion->estado_notificacion === 'aceptada')
                    <p><strong>La solicitud de adopción del gato {{ $notificacion->kitten->nombre }} ha sido aceptada.</strong></p>
                @elseif($notificacion->estado_notificacion === 'rechazada')
                    <p><strong>La solicitud de adopción del gato {{ $notificacion->kitten->nombre }} ha sido rechazada.</strong></p>
                @endif
