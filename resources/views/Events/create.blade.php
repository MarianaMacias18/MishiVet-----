...
<x-edit-component 
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control @error('ubicacion') is-invalid @enderror" required name="ubicacion" value="{{ old('ubicacion', $event->pivot->ubicacion ?? '') }}">
        @error('ubicacion')
            <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
            </span>
    ...
    <div class="form-group">
        ...
        <input type="number" class="form-control @error('participantes') is-invalid @enderror" required name="participantes" value="{{ old('participantes', $event->pivot->participantes ?? '') }}">
        @error('participantes')
            <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
            </span>
