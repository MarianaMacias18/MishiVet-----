...
<div class="background-video position-relative">
    <video class="position-fixed top-0 start-0 w-100 h-100 object-fit-cover" src="{{ asset('video/refugio.mp4') }}" muted loop autoplay></video>
    <div class="container mt-5">
        <h1 class="text-center mb-4 text-primary"><strong>MIS REFUGIOS</strong></h1>
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="card shadow-lg h-100 border-dark rounded" style="margin: 10px; display: flex; flex-direction: column; background-color: rgba(255, 255, 255, 0.75);">
                            ...
                            <a href="{{ route('shelters.show', $shelter) }}" style="text-decoration: none; flex-grow: 1; color: inherit;">
                                ...
                                <div class="card-body bg-white bg-opacity-25 text-dark rounded-3">
                                    <h5 class="card-title text-success"><strong>{{ $shelter->nombre }}</strong></h5>
